module FtF2MDiscoverypublisher
  ...
  @@required_fields = %w(publication)
  @@jsonld_required_fields = %w(publisher)
  ...
  def ft_f2_m_discoverypublisher(url_record)
    ...
    meta = {
      ...
      endpoint_url: 'https://fair-tests.fairsharing.org/test/ft_f2_m_discoverypublisher',
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_f2_m_discoverypublisher/api',
    }
