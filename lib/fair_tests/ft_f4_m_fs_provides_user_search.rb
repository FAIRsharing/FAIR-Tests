...
module FtF4MFsProvidesUserSearch
  require_relative '../fair_test_utils'
  include FairTestUtils

  def ft_f4_m_fs_provides_user_search(url_record)
    ...
    meta = {
      ...
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.a03f6b',
      license: 'https://creativecommons.org/licenses/by/4.0/',
      testversion: '1.0.0',
      protocol: 'https',
      host: 'ostrails.github.io',
      basePath: '/assessment-component-metadata-records/test/',
      endpoint_url: 'https://fair-tests.fairsharing.org/test/ft_f4_m_fs_provides_user_search',
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_f4_m_fs_provides_user_search/api',
    }
