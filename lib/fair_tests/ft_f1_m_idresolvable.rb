module FtF1MIdresolvable
  ...
  def ft_f1_m_idresolvable(url_record)
    ...
    meta = {
      ...
      endpoint_url: 'https://fair-tests.fairsharing.org/test/ft_f1_m_idresolvable',
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_f1_m_idresolvable/api',
    }
