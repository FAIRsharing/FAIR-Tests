module FtF1MMetadataIdPersistent
  ...
  def ft_f1_m_metadata_id_persistent(url_record)
    ...
    meta = {
      testid: 'FT_F1_M_MetadataIdPersistent.ttl',
      testname: 'FAIR Test - F1 - Metadata - Metadata contains identifier that is guaranteed persistent',
      description: "This test evaluates whether the metadata retrieved from the provided URI contains an identifier that satisfies the FAIRsharing definition of guaranteed persistence, as aligned with the EOSC PID Policy. Note that it assesses the metadata retrieved from the URI rather than the URI itself. During assessment, the provided URI is resolved in accordance with FAIRsharing’s identifier resolution best practices. If the record contains DOI or ARK identifiers it will pass. If any identifier URLs can be determined as persistent via FAIRsharing data the test will also pass. Otherwise, it will fail. The expected input is the URL of the resource to be tested.",
      keywords: ['FAIR', 'F1', 'PID', 'persistent identifiers'],
      creator: 'https://orcid.org/0000-0002-6468-9260',
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.9ee99f',
      license: 'https://creativecommons.org/licenses/by/4.0/',
      testversion: '1.0.0',
      protocol: 'https',
      host: 'ostrails.github.io',
      basePath: '/assessment-component-metadata-records/test/',
      endpoint_url: 'https://fair-tests.fairsharing.org/test/ft_f1_m_metadata_id_persistent',
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_f1_m_metadata_id_persistent/api',
    }
