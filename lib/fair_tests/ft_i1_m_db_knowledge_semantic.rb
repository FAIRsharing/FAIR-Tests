module FtI1MDbKnowledgeSemantic
  ...
  def ft_i1_m_db_knowledge_semantic(url_record)
    ...
    meta = {
      ...
      description: "This test checks whether the hosting database declares support for metadata formats that are semantically grounded (grounded/linked data), as recorded in its FAIRsharing registry entry. Expected input is the homepage URL of a resource which has a record in FAIRsharing.",
