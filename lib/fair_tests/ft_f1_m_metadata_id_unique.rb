module FtF1MMetadataIdUnique
  ...
  def ft_f1_m_metadata_id_unique(url_record)
    ...
    meta = {
      ...
      description: "This test evaluates whether the metadata retrieved from the provided URI contains an identifier that satisfies the FAIRsharing definition of guaranteed global uniqueness, as aligned with the EOSC PID Policy. Note that it assesses the metadata retrieved from the URI rather than the URI itself. During assessment, the provided URI is resolved in accordance with FAIRsharing’s identifier resolution best practices. If the record contains DOI or ARK identifiers it will pass. If any identifier URLs can be determined as globally unique via FAIRsharing data the test will also pass. Otherwise, it will fail. Expected input is a resolvable URL or identifier for the metadata record of the digital research object under evaluation.",
      keywords: ['FAIR', 'F1', 'GUID', 'unique identifiers'],
      creator: 'https://orcid.org/0000-0002-6468-9260',
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.f03ac8',
