...
module FtI3MFsDbVersionedContent
  ...
  def ft_i3_m_fs_db_versioned_content(url_record)
    ...
    meta = {
      ...
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.55789c',
      ...
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_i3_m_fs_db_versioned_content/api',
    }
