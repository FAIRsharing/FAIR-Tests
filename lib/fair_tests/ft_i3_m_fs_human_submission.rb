...
module FtI3MFsHumanSubmission
  ...
  def ft_i3_m_fs_human_submission(url_record)
    ...
    meta = {
      ...
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.d46837',
      ...
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_i3_m_fs_human_submission/api',
    }
