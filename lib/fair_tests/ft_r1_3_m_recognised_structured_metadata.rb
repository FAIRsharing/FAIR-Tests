module FtR13MRecognisedStructuredMetadata
  ...
  def ft_r1_3_m_recognised_structured_metadata(url_record)
    ...
    meta = {
      ...
      description: 'This test evaluates whether the dataset metadata is structured according to predefined, widely adopted metadata schemas appropriate to institutional repositories and other generalist contexts, such as schema.org (JSON-LD) or DataCite. It checks the record’s landing page for embedded or linked structured data that can be successfully parsed against the declared community schema. Finding JSON+LD or XML formats will result in a pass; otherwise, the test will fail. Expected input is a resolvable URL or identifier for the metadata record of the digital research object under evaluation.',
      keywords: ['FAIR', 'R1.3', 'recognised structured metadata'],
      creator: 'https://orcid.org/0000-0002-6468-9260',
      indicators: [],
      metric: 'https://doi.org/10.25504/FAIRsharing.389fad',
