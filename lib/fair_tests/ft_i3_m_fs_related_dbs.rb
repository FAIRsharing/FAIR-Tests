module FtI3MFsRelatedDbs
  ...
  def ft_i3_m_fs_related_dbs(url_record)
    ...
    meta = {
      ...
      description: 'This test assesses whether the FAIRsharing database record contains at least one shares_data_with or related_to relationship linking it to another FAIRsharing database record. To pass, a relationship with shares_data_with or related_to label with other database should exist, else the test will fail. This test expects as input the FAIRsharing DOI or URL for the FAIRsharing record under evaluation.',
      ...
      endpoint_description: 'https://fair-tests.fairsharing.org/test_descriptions/ft_i3_m_fs_related_dbs/api',
    }
