...
require_relative '../lib/fair_tests/ft_r1_3_m_fs_training_resources'

class FtR13MFsTrainingResourcesTest < Minitest::Test
  include ::TestHelper
  include ::FtR13MFsTrainingResources
  ...
  def test_passes_when_search_support_links_follows_conditions
    ...
    post '/test/ft_r1_3_m_fs_training_resources',
    ...
    assert_includes last_response.body, 'the resource provides training resources.'
  end
