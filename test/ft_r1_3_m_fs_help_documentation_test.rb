...
require_relative '../lib/fair_tests/ft_r1_3_m_fs_help_documentation'

class FtR13MFsHelpDocumentationTest < Minitest::Test
  include ::TestHelper
  include ::FtR13MFsHelpDocumentation
  ...
  def test_passes_when_search_support_links_follows_conditions
    ...
    post '/test/ft_r1_3_m_fs_help_documentation',
    ...
    assert_includes last_response.body, 'provides support through user-facing help documentation'
  end




  def test_fails_when_search_support_links_is_not_help
    stub_fairsharing_record(record_with_support_links([
                                                        {
                                                          'name' => 'Doc',
                                                          'type' => 'Contact form',
