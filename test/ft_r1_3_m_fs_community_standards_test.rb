...
require_relative '../lib/fair_tests/ft_r1_3_m_fs_community_standards'

class FtR13MFsCommunityStandardsTest < Minitest::Test
  include ::TestHelper
  include ::FtR13MFsCommunityStandards
  ...
  def test_pass_ft_related_standards
    ...
    post '/test/ft_r1_3_m_fs_community_standards',
  ...
  def test_fail_ft_r1_3_m_fs_community_standards
    stub_request(:post, "#{ENV['FAIRSHARING_API_URL']}").
      with(headers: headers).to_return(
      status: 200,
      body: {
  ...
  def test_fail_not_correct_registry_ft_r1_3_m_fs_community_standards
  ...
  def test_indeterminate_ft_r1_3_m_fs_community_standards
    stub_request(:post, "#{ENV['FAIRSHARING_API_URL']}").
      with(headers: headers).to_return(
      status: 200,
      body: {
