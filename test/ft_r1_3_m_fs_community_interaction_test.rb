...
require_relative '../lib/fair_tests/ft_r1_3_m_fs_community_interaction'

class FtR13MFsCommunityInteractionTest < Minitest::Test
  include ::TestHelper
  include ::FtR13MFsCommunityInteraction
  ...
  def test_passes_when_search_support_links_follows_conditions
    ...
    post '/test/ft_r1_3_m_fs_community_interaction',
    ...
    assert_includes last_response.body, 'the resource supports community interaction.'
  end
