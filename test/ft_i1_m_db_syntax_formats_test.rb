...
require_relative '../lib/fair_tests/ft_i1_m_db_syntax_formats'

class FtI1MDbSyntaxFormatsTest < Minitest::Test
  include ::TestHelper
  include ::FtI1MDbSyntaxFormats
  ...
  def test_is_syntactic
    ...
    post '/test/ft_i1_m_db_syntax_formats',
