...
require_relative '../lib/fair_tests/ft_f1_m_idresolvable'

class FtF1MIdresolvableTest < Minitest::Test
  include ::TestHelper
  include ::FtF1MIdresolvable
  ...
  def test_is_resolvable
    ...
    post '/test/ft_f1_m_idresolvable',
