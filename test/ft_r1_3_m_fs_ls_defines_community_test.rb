...
require_relative '../lib/fair_tests/ft_r1_3_m_fs_ls_defines_community'

class FtR13MFsLsDefinesCommunityTest < Minitest::Test
  include ::TestHelper
  include ::FtR13MFsLsDefinesCommunity
  ...
  def test_passes_when_there_is_valid_record_object_type
    ...
    post '/test/ft_r1_3_m_fs_ls_defines_community',
    ...
    assert_includes last_response.body, 'the resource defines its Life Science community'
  end
  ...
  def test_fails_when_no_subject_life_science_is_present
    stub_fairsharing_record(record_with_object_types([{
                                                        'id' => 13,
                                                        'label' => 'data'
                                                      },
                                                     ...
                                                     [{
                                                        "id" => 138,
                                                        "label" => "Bio",
                                                        "ancestors" => [{"id" => 1380, "label" => "Nature"}]
                                                      }
                                                     ]))
