...
require_relative '../lib/fair_tests/ft_i3_m_fs_machine_submission'

class FtI3MFsMachineSubmissionTest < Minitest::Test
  include ::TestHelper
  include ::FtI3MFsMachineSubmission

  def test_passes_when_search_process_no_uses_user_interface_for_write
    ...
    post '/test/ft_i3_m_fs_machine_submission',
    ...
    assert_includes last_response.body, 'the database allows content submission by machines.'
  end

  def test_passes_when_browse_process_no_uses_user_interface_for_read_write
    stub_fairsharing_record(record_with_processes([
                                                   {
  ...
  def test_fails_when_search_process_is_user_interface
    stub_fairsharing_record(record_with_processes([
                                                    {
                                                      'name' => 'Browse datasets',
                                                      'type' => 'read/write',
  ...
  def test_fails_when_no_user_interface_process_is_not_writable
    stub_fairsharing_record(record_with_processes([
                                                   {
                                                     'name' => 'Search records',
                                                     'type' => 'read',
